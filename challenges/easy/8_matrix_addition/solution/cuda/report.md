...
- Backend: `cuda`
- Status: **passed**
- Updated: 2026-08-09T06:09:13+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 1.02707 ms |
| GPU latency p90 | 1.03352 ms |
| GPU latency p99 | 1.05135 ms |
| End-to-end latency p50 | 1.03765 ms |
| Host/sync overhead p50 | 0.010578 ms |
| Host/sync overhead ratio p50 | 1.01942 % |
| Call throughput | 973.642 calls/s |
| Output element throughput | 1.6335e+10 elements/s |
| Reference speedup | 0.982989 x |
| Reference GPU latency p50 | 1.0096 ms |
| Reference effective bandwidth p50 | 199.412 GB/s |
...
| Effective bandwidth, best | 197.957 GB/s |
| Effective bandwidth, p50 | 196.02 GB/s |
| Effective bandwidth, mean | 195.848 GB/s |
| Effective bandwidth, p90 latency | 194.798 GB/s |
