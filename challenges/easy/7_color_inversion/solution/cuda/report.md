...
- Backend: `cuda`
- Status: **passed**
- Updated: 2026-08-09T04:48:11+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 0.748112 ms |
| GPU latency p90 | 0.772202 ms |
| GPU latency p99 | 0.853371 ms |
| End-to-end latency p50 | 0.76165 ms |
| Host/sync overhead p50 | 0.013538 ms |
| Host/sync overhead ratio p50 | 1.77746 % |
| Call throughput | 1336.7 calls/s |
| Output element throughput | 1.1213e+11 elements/s |
| Reference speedup | 2.42821 x |
| Reference GPU latency p50 | 1.81658 ms |
| Reference effective bandwidth p50 | 92.3563 GB/s |
...
| Effective bandwidth, best | 228.189 GB/s |
| Effective bandwidth, p50 | 224.261 GB/s |
| Effective bandwidth, mean | 222.225 GB/s |
| Effective bandwidth, p90 latency | 217.265 GB/s |
