...
- Backend: `triton`
- Status: **passed**
- Updated: 2026-08-10T09:01:37+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 0.023616 ms |
| GPU latency p90 | 0.0247552 ms |
| GPU latency p99 | 0.0280781 ms |
| End-to-end latency p50 | 0.0355 ms |
| Host/sync overhead p50 | 0.011884 ms |
| Host/sync overhead ratio p50 | 33.4761 % |
| Call throughput | 42344.2 calls/s |
| Output element throughput | 4.23442e+09 elements/s |
| Reference speedup | 1.25745 x |
...
| Effective bandwidth, best | 35.461 GB/s |
| Effective bandwidth, p50 | 33.8753 GB/s |
| Effective bandwidth, mean | 33.3037 GB/s |
| Effective bandwidth, p90 latency | 32.3164 GB/s |
