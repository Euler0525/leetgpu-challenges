...
- Backend: `pytorch`
- Status: **passed**
- Updated: 2026-08-10T08:55:39+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 0.014336 ms |
| GPU latency p90 | 0.0663744 ms |
| GPU latency p99 | 0.0707613 ms |
| End-to-end latency p50 | 0.02425 ms |
| Host/sync overhead p50 | 0.009914 ms |
| Host/sync overhead ratio p50 | 40.8825 % |
| Call throughput | 69754.5 calls/s |
| Output element throughput | 6.97545e+09 elements/s |
| Reference speedup | 2.20312 x |
| Reference GPU latency p50 | 0.031584 ms |
| Reference effective bandwidth p50 | 25.3293 GB/s |
...
| Effective bandwidth, best | 195.313 GB/s |
| Effective bandwidth, p50 | 55.8036 GB/s |
| Effective bandwidth, mean | 32.1062 GB/s |
| Effective bandwidth, p90 latency | 12.0528 GB/s |
