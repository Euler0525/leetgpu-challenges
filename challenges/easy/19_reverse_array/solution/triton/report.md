...
- Backend: `triton`
- Status: **passed**
- Updated: 2026-08-10T02:57:57+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 0.85248 ms |
| GPU latency p90 | 0.876646 ms |
| GPU latency p99 | 0.88075 ms |
| End-to-end latency p50 | 0.86565 ms |
| Host/sync overhead p50 | 0.01317 ms |
| Host/sync overhead ratio p50 | 1.5214 % |
| Call throughput | 1173.05 calls/s |
| Output element throughput | 2.93262e+10 elements/s |
| Reference speedup | 2.01438 x |
| Reference GPU latency p50 | 1.71722 ms |
| Reference effective bandwidth p50 | 116.468 GB/s |
...
| Effective bandwidth, best | 235.885 GB/s |
| Effective bandwidth, p50 | 234.61 GB/s |
| Effective bandwidth, mean | 233.357 GB/s |
| Effective bandwidth, p90 latency | 228.142 GB/s |
