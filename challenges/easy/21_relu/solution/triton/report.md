...
- Backend: `triton`
- Status: **passed**
- Updated: 2026-08-10T06:00:41+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 0.896944 ms |
| GPU latency p90 | 0.907133 ms |
| GPU latency p99 | 0.928134 ms |
| End-to-end latency p50 | 0.9081 ms |
| Host/sync overhead p50 | 0.011156 ms |
| Host/sync overhead ratio p50 | 1.2285 % |
| Call throughput | 1114.9 calls/s |
| Output element throughput | 2.78724e+10 elements/s |
| Reference speedup | 2.26961 x |
| Reference GPU latency p50 | 2.03571 ms |
| Reference effective bandwidth p50 | 98.2457 GB/s |
...
| Effective bandwidth, best | 224.755 GB/s |
| Effective bandwidth, p50 | 222.979 GB/s |
| Effective bandwidth, mean | 222.363 GB/s |
| Effective bandwidth, p90 latency | 220.475 GB/s |
