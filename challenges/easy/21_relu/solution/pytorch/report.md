...
- Backend: `pytorch`
- Status: **passed**
- Updated: 2026-08-10T05:55:21+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 0.881664 ms |
| GPU latency p90 | 0.884829 ms |
| GPU latency p99 | 0.888238 ms |
| End-to-end latency p50 | 0.8934 ms |
| Host/sync overhead p50 | 0.011736 ms |
| Host/sync overhead ratio p50 | 1.31364 % |
| Call throughput | 1134.22 calls/s |
| Output element throughput | 2.83555e+10 elements/s |
| Reference speedup | 2.30295 x |
| Reference GPU latency p50 | 2.03043 ms |
| Reference effective bandwidth p50 | 98.5012 GB/s |
...
| Effective bandwidth, best | 229.047 GB/s |
| Effective bandwidth, p50 | 226.844 GB/s |
| Effective bandwidth, mean | 226.939 GB/s |
| Effective bandwidth, p90 latency | 226.032 GB/s |
