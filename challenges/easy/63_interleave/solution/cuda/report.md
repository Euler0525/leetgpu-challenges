...
- Backend: `cuda`
- Status: **passed**
- Updated: 2026-08-10T09:22:45+00:00
...
| Metric | Value |
|---|---:|
| GPU latency p50 | 1.76184 ms |
| GPU latency p90 | 1.80681 ms |
| GPU latency p99 | 1.82359 ms |
| End-to-end latency p50 | 1.7767 ms |
| Host/sync overhead p50 | 0.01486 ms |
| Host/sync overhead ratio p50 | 0.836383 % |
| Call throughput | 567.588 calls/s |
| Output element throughput | 2.83794e+10 elements/s |
| Reference speedup | 1.77787 x |
| Reference GPU latency p50 | 3.13232 ms |
| Reference effective bandwidth p50 | 127.701 GB/s |
...
| Effective bandwidth, best | 228.971 GB/s |
| Effective bandwidth, p50 | 227.035 GB/s |
| Effective bandwidth, mean | 225.781 GB/s |
| Effective bandwidth, p90 latency | 221.384 GB/s |
